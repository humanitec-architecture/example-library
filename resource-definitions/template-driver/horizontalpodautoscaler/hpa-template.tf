resource "humanitec_resource_definition" "hpa-template" {
...
resource "humanitec_resource_definition_criteria" "hpa-template_criteria_0" {
  resource_definition_id = resource.humanitec_resource_definition.hpa-template.id
